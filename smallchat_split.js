/*
	...
	* 201005
	...
	'! 하고싶은말'의 형식으로 입력하면 화면내의 별도의 영역에 채팅을 표시해주는 스크립트입니다.
	잡담한 내역은 자동으로 생성되는 핸드아웃에 저장됩니다.
	...
	3. 코드 내의 주석을 참조해서 옵션을 설정합니다. 글자 크기, 색상, 여백 등을 세팅할 수 있습니다.
	4. [Save Script]로 저장합니다. 
	5. 페이지 아래쪽의 API Output Console에 에러 메시지가 표시되지 않는다면 정상적으로 적용된 것입니다.
	
	준비2. 잡담창 배경 및 영역 설정
	1. 잡담창을 표시할 세션방의 map 레이어에 채팅창 배경으로 사용할 이미지를 삽입하고 이름을 'chat_bg'로 설정합니다.
	2. '! 하고싶은말'의 형식으로 채팅창에 입력해봅니다.
	3. 설정한 배경 위에 채팅창이 표시되는지 확인합니다.
	4. 저널에 잡담로그를 저장하는 핸드아웃이 자동으로 생성되었는지 확인합니다.
*/
on('ready', function() {
